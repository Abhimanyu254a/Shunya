...
public:
		...
		:Layer("Example"), m_Camera(-1.6f, 1.6f, -0.9f, 0.9f),m_CameraPosition(0.0f)
	{
		...
		m_Shader.reset(new Shunya::Shader(vertexSrc, fragmentSrc));
	...
	void OnUpdate(Shunya::Timestamp ts) override
	{
		...
		// --- RENDER SQUARE ---
		Shunya::Renderer::Submit(m_BlueShader, m_SquareVA);

		// --- RENDER TRIANGLE ---
		Shunya::Renderer::Submit(m_Shader, m_VertexArray);
...
private:
	...
	std::shared_ptr<Shunya::Shader>m_BlueShader;
