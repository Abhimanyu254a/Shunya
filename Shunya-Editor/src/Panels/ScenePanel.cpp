...
//                (void*)typeid(T).hash_code(), treeNodeFlags, name.c_str());
//            ImGui::PopStyleVar();
//
...
//                        }
//                        if (isSelected)
//                            ImGui::SetItemDefaultFocus(); // ✅ inside loop scope
//                    }
//                    ImGui::EndCombo();
//                }
//
...
//                }
//
//                // ── Orthographic ── ✅ now correctly INSIDE the lambda
...
//                        else
//                            SHUNYA_WARNING("Could not load texture {0}", texturePath.filename().string());
//                    }
...
namespace Shunya {
    ...
    void SceneHierarchyPanel::OnImGuiRender()
    {
        ...
        } // ✅ FIXED: This missing brace caused the C2267 block scope errors
                ...
                if (ImGui::BeginDragDropTarget())
                {
                    if (const ImGuiPayload* payload = ImGui::AcceptDragDropPayload("CONTENT_BROWSER_ITEM"))
                    {
                        ...
                        if (texture->IsLoaded())
                            ...
                            SHUNYA_CORE_WARNING("Could not load texture {0}", texturePath.filename().string());
                    }
                    ImGui::EndDragDropTarget();
                }
